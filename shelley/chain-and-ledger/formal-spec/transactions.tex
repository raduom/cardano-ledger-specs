...
\begin{itemize}
  ...
  \item $\HasDV$: This is a tag used to indicate whether the transaction carrying
  the output the tag is attached to also contains the full datum object corresponding
  to the data hash in the output (this tag only applies to Plutus script outputs)
  ...
  to make the destinction between a transaction input type and UTxO keys.
...
\begin{itemize}
  ...
  purposes - forgin, outputs, certificates, and withdrawals)
